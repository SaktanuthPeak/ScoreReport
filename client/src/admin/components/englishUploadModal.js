    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const updatePromises = data.map(async (studentData) => {
                ...
                const username = studentData.username || studentData.UID || studentData.id;
                ...
                try {
                    ...
                    if (student.data.data.length > 0) {
                        ...
                        await ax.put(`/scores/${studentRecord.documentId}`, { data: payload });
...
export default EnglishUploadModal;